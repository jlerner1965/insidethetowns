# Content for Inside Elizabeth

Everything on insideelizabeth.com that is not layout lives in this folder. Edit
...
TOWN=elizabeth npm run dev   # preview at http://localhost:4321
```
