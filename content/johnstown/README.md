# Content for Inside Johnstown

Everything on insidejohnstown.com that is not layout lives in this folder. Edit
...
TOWN=johnstown npm run dev   # preview at http://localhost:4321
```
