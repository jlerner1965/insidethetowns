# Venue photo requests, ready to send
...
real address on the town's own domain where you have one
(`hello@insideberthoud.com` and so on): a request from the site being asked
about is answered far more often than one from a generic address.

## Read this first — six of the 21 need no permission at all

These are public exteriors or public art on a public street. Photograph them on
the same walk that `PHOTOS.md` describes and skip the email entirely:

| Venue | Town | Where |
|---|---|---|
| Downtown mural and public art walk | Berthoud | Mountain Ave, 2nd to 8th |
| Berthoud Town Hall | Berthoud | 807 Mountain Ave |
| First National Bank building | Elizabeth | 188 S Main St — exterior only, it is closed |
| Historic walking tour of Old Town | Johnstown | Starts 701 Charlotte St — shoot any stop |
| Niwot Hall | Niwot | 195 Second Ave |
| Timnath Town Center | Timnath | 4750 Signal Tree Dr |

That leaves 15 venues that do need an ask: 13 where a contact is held, and two
where none is. The three numbers partition the 21 exactly — 6 + 13 + 2 — so
nothing below is counted twice.

Two of the emails below ask the same two questions as the parks ones, for the
same reasons:

1. **May we use photographs you already hold?** A library, museum or theatre
   almost always has a file of publicity images, and sending three is less work
   for them than anything else you could ask.
2. **May we photograph the interior?** Exteriors need nobody's permission.
   Interiors do, and asking now costs nothing.

When permission comes back, record it. Add the image with a row in
`IMAGE_LICENSES.csv`:

```
content/<town>/images/<file>.jpg,<their page or the email>,Used with permission of <body> (<date>),y,<town>
```

Keep the reply itself. Permission you cannot produce later is not permission.
...
# Part 2 — the 139 businesses

`PHOTO-CONTACTS.csv` lists all 139 with whatever address, phone, website and
hours the repository holds. `PHOTOS.md` §2 has the ask itself. What neither
gives you is a way to avoid sending 139 separate emails.

## What the contact data actually supports
...
## Per town, and who can introduce you
...
|---|---|---|
| Berthoud | 33 | Berthoud Main Street — https://berthoudmainstreet.org/contact/ |
| Niwot | 28 | Niwot Business Association — https://niwot.com/ |
| Lyons | 24 | **No chamber website exists.** Walk this one, or ask the Town's visitor programme at https://www.lyonscolorado.com/ |
| Elizabeth | 16 | Elizabeth Main Street — https://www.elizabethmainstreet.org/ |
| Erie | 15 | Downtown Erie — https://www.downtownerie.biz/ · Erie Chamber — https://eriechamber.org/ |
| Johnstown | 13 | Johnstown Downtown Development Association — https://www.visitdowntownjohnstown.com/ |
| Timnath | 10 | Downtown Timnath — https://downtowntimnath.com/ · Timnath Chamber — https://timnathchamber.com/ |

**On the Berthoud Area Chamber.** They can be emailed like anyone else, and this
request is a perfectly ordinary thing to email a chamber about. But their
`robots.txt` disallows 74 named AI and scraper user-agents, so do not point
anything automated at their site — see `BACKLINKS.md`. Berthoud Main Street is
the better route for downtown businesses in any case, because the downtown
programme is theirs.
...
The 21 venues partition into three groups that do not overlap. **13 + 2 + 6 = 21.**

### Needs an ask, contact held — 13 sites
...
| 6 | Pines & Plains Libraries | Elizabeth Library | | | |
| 7 | Erie Historical Society | Wise Homestead Museum | | | |
| 8 | Johnstown Historical Society | Historic Parish House & Museum | | | |
| 9 | Johnstown-Milliken Public Libraries | Glenn A. Jones Library | phone | | no address published |
| 10 | YMCA of Northern Colorado | Johnstown Community YMCA | phone | | no address published |
| 11 | Candlelight Dinner Playhouse | Candlelight Dinner Playhouse | phone | | site blocks automated clients |
| 12 | Lyons Regional Library District | Lyons Regional Library | | | |
| 13 | Osmosis Gallery | Osmosis Gallery | | | |
| 14 | Lyons Classic Pinball | Lyons Classic Pinball | | | |

Emails 2 and 8 each also mention a site from the no-permission group — Berthoud
Town Hall and the Old Town walking tour — because they go to the body that owns
both. Those two sites are counted below, not here. Email 4, to Berthoud Main
Street, covers only the murals and is optional for the same reason.

### Needs an ask, no contact held — 2 sites

| Venue | Town | Address | Visited | Outcome |
|---|---|---|---|---|
| B-Rad's Arcade | Berthoud | 154 Mountain Ave | | |
| Elbert County Artists Guild | Elizabeth | 338 S Main St | | |

### Needs no permission — 6 sites

Photograph on the walk. No email belongs in this row.

| Venue | Town | Photographed |
|---|---|---|
| Downtown mural and public art walk | Berthoud | |
| Berthoud Town Hall | Berthoud | |
| First National Bank building | Elizabeth | |
| Historic walking tour of Old Town | Johnstown | |
| Niwot Hall | Niwot | |
| Timnath Town Center | Timnath | |

| Town | Businesses | Introduction sent | Newsletter ran | Photos received |
|---|---|---|---|---|
| Berthoud | 33 | | | |
| Niwot | 28 | | | |
| Lyons | 24 | walk first | | |
